...
var _plpReducer = __webpack_require__(75);

var _plpReducer2 = _interopRequireDefault(_plpReducer);
...
var store = (0, _redux.createStore)(_plpReducer2.default);
...
var _productCard = __webpack_require__(70);
...
var _sorting = __webpack_require__(72);
...
var _plpAction = __webpack_require__(74);

var _plpAction2 = _interopRequireDefault(_plpAction);
...
var ProductListing = function (_React$Component) {
    ...
    function ProductListing(props) {
        ...
        _this.createCardList = function () {
            debugger;
            var searchString = _this.props.searchString;
            var filterString = _this.props.filterString;
            var filteredCards = _this.props.products;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-10' },
                        _react2.default.createElement(_search2.default, { searchHandler: this.props.searchHandler })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-2' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-2' },
                        _react2.default.createElement(_filter2.default, { filterHandler: this.props.filterHandler })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-10' },
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        showProducts: function showProducts() {
            return dispatch(_plpAction2.default);
        },
        searchHandler: function searchHandler(searchString) {
            return dispatch({ type: 'SEARCH_STRING', value: searchString });
        },
        filterHandler: function filterHandler(filterString) {
            return dispatch({ type: 'FILTER_STRING', value: filterString });
        }
    };
};
    ...
    _createClass(Filter, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                "All",
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "radio", checked: this.state.filterString === "shirts", onClick: function onClick(evt) {
                        return _this2.onFilterClick(evt);
                    }, onChange: function onChange(evt) {
                        return _this2.onFilter(evt);
                    }, value: "shirts" }),
                "Shirt",
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "radio", checked: this.state.filterString === "jeans", onClick: function onClick(evt) {
                        return _this2.onFilterClick(evt);
                    }, onChange: function onChange(evt) {
                        return _this2.onFilter(evt);
                    }, value: "jeans" }),
                "Jeans",
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "radio", checked: this.state.filterString === "tshirts", onClick: function onClick(evt) {
                        return _this2.onFilterClick(evt);
                    }, onChange: function onChange(evt) {
                        return _this2.onFilter(evt);
                    }, value: "tshirts" }),
